...
;(function (factory) {
	...
	var Pagination = function(element,options){
		...
		this.filling = function(index){
			...
			html += opts.jump ? '<span>共</span><span class="to-jump1">前往</span><input type="text" class="'+opts.jumpIptCls+'"><span class="to-jump2">页</span><a href="javascript:;" class="'+opts.jumpBtnCls+'">'+opts.jumpBtn+'</a>' : '';
			$obj.empty().html(html);
		};
